...
public class PessoaFisica extends Cliente {
    ...
    public String paraString() {
        return "Pessoa Física," + super.getNome() + "," + super.getEndereco().getCep() + "," + super.getEndereco().getBairro() + "," + super.getEndereco().getCidade() + "," + super.getEndereco().getEstado() + "," + super.getEndereco().getNumero() + "," + super.getEndereco().getRua() + "," + super.getDataCadastro() + "," + getCpf() + "," + getQuantidadeMaximaParcelas();
        /*
